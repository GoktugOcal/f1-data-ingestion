...
def download_data(
    ...
    Raises:
    - EasyF1Exception: Raised if any of the required parameters are missing or if no matching data is found.
    """
    ...
    if season_identifier is None:
        raise EasyF1Exception("Please provide at least a `season_identifier`.")
    ...
    try:
        ...
        if location_identifier:
            ...
            if meeting_data:
                ...
                raise EasyF1Exception(f"Meeting at location '{location_identifier}' not found.")
        else:
        ...
        if session_identifier:
            ...
            if session_data:
                ...
                raise EasyF1Exception(f"Session with identifier '{session_identifier}' not found.")

    except Exception as e:
        # Catch any exception and wrap it in a custom EasyF1Exception
        raise EasyF1Exception(e) from e
