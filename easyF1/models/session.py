...
class Session:
    ...
    Attributes:
        ...
        feeds_info (dict): Information about available data feeds for the session.
    ...
    def get_feeds(self):
        """
        Retrieves information about available data feeds for the session.

        Returns:
            dict: Information about the feeds available for the session.
        """
        self.feeds_info = livetimingF1_request(urljoin(self.full_path, "Index.json"))["Feeds"]
